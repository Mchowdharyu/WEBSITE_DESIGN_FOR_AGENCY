    ...
    <div class="container-fluid px-1 py-5" style="margin: auto;">
        <div class="row d-flex justify-content-center">
            <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center insert-form">
                <h3>Defaulter's Records</h3>
                <p class="blue-text">Below are the customers who have not finished paying their items</p>
                <div class="card">
                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                    <?php $sql = "SELECT * FROM customer where price < 1200";
